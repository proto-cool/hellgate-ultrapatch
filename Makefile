...
SRC     := src/dllmain.c src/proxy.c src/hook.c src/panel.c src/overlay.c src/device.c src/hdr.c src/postfx.c src/compare.c src/brand.c src/plshadow.c src/volfog.c src/crashlog.c src/cull.c src/inputfilter.c src/invprobe.c src/uiext.c src/invsort.c src/invplan.c src/settings.c src/optpage.c \
