#!/usr/bin/env python3
"""
Rebuild a material effect with our own shaders (notes/graphics-plan.md step 7).

    python3 tools/mkmat.py plan  <stock.fxo> <family> <workdir>
    python3 tools/mkmat.py build <stock.fxo> <family> <workdir> <out.fxo>
...
defines for tools/shaders/<family>.hlsl and writes <workdir>/batch.txt, one
