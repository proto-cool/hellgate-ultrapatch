...
per-pixel point-light pass (docs/graphics-plan.md step 1).

    python3 tools/fx/mkfx.py <extracted-root> <shader-bin-dir> <override-root>
...
Shader blobs come from shaders/actor_lights.fx compiled by the
Microsoft effect compiler (tools/fx/build_shaders.sh) as
