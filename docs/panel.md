...
| Post | **Ambient occlusion, show it alone, radius, strength, less in sun** | screen-space AO after the opaque scene; *show* draws the occlusion by itself; *less in sun* eases it off where the sun lights the surface |
