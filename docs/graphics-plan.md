...
1. **Point lights in the base pass.** Move per-pixel lighting into our
   material shaders, for backgrounds as well as characters, and drop the
   additive clone pass. The engine's cap is 5 lights per mesh; raising it
